<html>
<head>
    <title> Coustomer Signup | Ck2 Cafe' </title>
  </head>
  ...
  <body  style="background-image: url('images/welcome.jpg') ;background-size: 100%">
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Coustomer, <br> Welcome to <span class="edit"> F.R.I.E.N.D.S Cafe' </span></h1>
     <br>
